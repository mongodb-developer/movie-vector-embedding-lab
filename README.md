...
Copy this function and paste it into the your `main.js` file. <br> Notice this function will look in the <>sample_mflix.movies</code> collection for 100 scary movies 🧟 with a plot field.
<code><br>
